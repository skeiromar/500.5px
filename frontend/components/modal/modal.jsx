...
class Modal extends Component {
  ...
  handleSubmit(e) {
    ...
    this.props.submitForm(formData).then(success => {
      this.closeMod();
  ...
  render() {
    ...
    //     component =    <form onSubmit={this.handleSubmit} className="file-container">
                        
    //                     <input type="file" onChange={this.handleFile} className="upload-modal-button" id="file-submit"/>
    //                     {/* <button  onChange={this.handleFile} >upload</button> */}
    //                     <input type="submit" value="submit"/>
    //                     </form>;
    //     break;
    //   case 'open':
    //     component = <h1>modal is closed</h1>;
    //     break;
    //   default:
    //     return null;
    // }

    const preview = this.state.picUrl ? <img src={this.state.picUrl} className="uploaded-modal-pic" /> : null;
    ...
    return !this.state.uploaded ? (
      ...
      <div className="modal-background" onClick={this.closeMod}>
        <div className="modal-child upload-modal-form" onClick={e => e.stopPropagation()}>
            ...
            <div className="upload-modal-second">
              <ul className="uploaded-modal-stuff">          
                ...
                <li className="add-more-pics">
                  <div className="modal-ico"><i className="fas fa-plus fa-2x"></i></div>
                  <div className="add-more-pics-txt">  Add more pictures</div>
                </li>
              </ul>
            </div>
